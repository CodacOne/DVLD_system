...
{
    public partial class ResultWrittenTest : Form
    {
        ...
        public ResultWrittenTest(DataTable Dt, int TestAppID)
        {
            InitializeComponent();
            _Dt = Dt;
        ...
        private void ResultWrittenTest_Load(object sender, EventArgs e)
        {
